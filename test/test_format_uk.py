...
class TestPronounceNumber(unittest.TestCase):
    ...
    def test_convert_stos(self):
        ...
        self.assertEqual(pronounce_number(103254654), "сто три мільйони "
                                                      "двісті п\'ятдесят "
                                                      "чотири тисячі "
                                                      "шістсот "
                                                      "п\'ятдесят чотири")
    ...
    def test_large_numbers(self):
        ...
        self.assertEqual(
            ...
            "сто квінтильйонів тридцять чотири квадрильйони "
            "двісті дев\'яносто дев\'ять мільйонів сімсот "
            "дев\'яносто дві тисячі чотириста п\'ятдесят вісім")
        self.assertEqual(
        ...
        self.assertEqual(pronounce_number(95505896639631893, short_scale=True),
                         "дев\'яносто п\'ять квадрильйонів "
                         "п\'ятсот п\'ять трильйонів "
        ...
        self.assertEqual(pronounce_number(1.9874522571e80, places=9),
                         "сто дев\'яносто вісім квінвігінтильйонів "
                         "сімсот сорок п\'ять кватторвігінтильйонів "
                         "двісті двадцять п\'ять тревігінтильйонів "
                         "сімсот дев\'ять дуовігінтильйонів "
                         "дев\'ятсот дев\'яносто дев\'ять унвігінтильйонів "
                         "дев\'ятсот вісімдесят дев\'ять вігінтильйонів "
                         "сімсот тридцять ундевігінтильйонів "
                         "дев\'ятсот дев\'ятнадцять дуодевігінтильйонів "
                         "дев\'ятсот дев\'яносто дев\'ять септдецильйонів "
                         "дев\'ятсот п\'ятдесят п\'ять сексдецильйонів "
                         "чотириста дев\'яносто вісім квіндецильйонів "
                         "двісті чотирнадцять кваттордецильйонів "
                         "вісімсот сорок п\'ять тредецильйонів "
                         "чотириста двадцять дев\'ять дуодецильйонів "
                         "чотириста сорок чотири ундецильйони "
                         "триста тридцять шість децильйонів "
                         "сімсот двадцять чотири нонильйони "
                         "п\'ятсот шістдесят дев\'ять октильйонів "
                         "триста сімдесят п\'ять септильйонів "
                         "двісті тридцять дев\'ять секстильйонів "
                         "шістсот сімдесят квінтильйонів "
                         "п\'ятсот сімдесят чотири квадрильйони "
                         "сімсот тридцять дев\'ять трильйонів "
                         "сімсот сорок вісім мільярдів "
                         "чотириста сімдесят мільйонів "
                         "дев\'ятсот п\'ятнадцять тисяч "
                         "сімдесят два")
    ...
    def test_ordinals(self):
        ...
        self.assertEqual(pronounce_number(1.672e-27, places=3,
                         ...
                         "один крапка шість сім два на десять в мінус "
                         "двадцять сьомому степені")
...
class TestNiceDateFormat(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for sub_dir in [x for x in p.iterdir() if x.is_dir()]:
            if (sub_dir / 'date_time_test.json').exists():
                ...
                with (sub_dir / 'date_time_test.json').open(encoding='utf-8') as f:
    ...
    def test_convert_times(self):
        ...
        dt = datetime.datetime(2017, 1, 31,
                               23, 45, 00, tzinfo=default_timezone())
        self.assertEqual(nice_time(dt, use_24hour=False),
